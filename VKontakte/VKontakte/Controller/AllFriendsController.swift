...
class AllFriendsController: UITableViewController {
    ...
    var friends = [
        User(name: "Ivan", image: UIImage(named: "friend1.jpeg")!),
        User(name: "Oleg", image: UIImage(named: "friend2.jpeg")!),
        User(name: "Katya", image: UIImage(named: "friend3.jpeg")!),
        User(name: "Olya", image: UIImage(named: "friend4.jpeg")!),
        User(name: "Sergey", image: UIImage(named: "friend5.jpeg")!),
        User(name: "Victoria", image: UIImage(named: "friend6.jpeg")!),
